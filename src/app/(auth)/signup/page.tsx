...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await authApi.signup({ id: userId, password });
     
      setSuccess(data.message || "Account created successfully!");
      // Call loginWithDetails from AuthContext to store user and redirect to details
      loginWithDetails(userId);
    } catch (err) {
          ...
          <div className="w-full max-w-md">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 text-sm">
                Welcome to Your Native Farm. Create an account to get started.
              </p>
            </div>
